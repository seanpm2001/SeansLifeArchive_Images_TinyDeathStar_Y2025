...
- I came back this week for weekly gameplay for a second consectuive week, playing in the late morning. I had a medium length session, as I didn;'t have as much time to play.
...
- **Imperial credits:** `~200,680` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `557`
- **In-game spending**
- - **iBux (spent):** `~798+`
- - **iBux (kept):** `557`
- - **iBux (all):** `~1,355+`
- - **iCredits (spent):** `at least 19,280,000`
- - **iCredits (kept):** `~200,680`
- - **iCredits (all):** `at least ~19,480,680`
...
- **Security systems:** `703` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `289`
- **Comlinks:** `200`
- **Internal forcefields:** `117`
- **Inspections:** `92`
- **Shield projectors:** `128`
- **Imperial Edict:** `46`
...
- **File version:** `1 (2025, Friday, February 21st at 01:42 pm PST)`
